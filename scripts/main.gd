...
func guide_topic_body(topic: String) -> String:
	match topic:
		...
		"cards":
			return "卡框顏色跟 OVR 走：青 65–70、綠 71–75、藍 76–80、紅 81–85、紫 86–90。特訓漲 OVR 會換卡色，年薪也會重抓。一般卡技能必須特訓 +5 才會在比賽生效，未解鎖仍會顯示技能說明。部分知名球星採用球迷熟悉的致敬名稱，例如 69大魔王、野獸覺醒、大房東收租與中華隊救星；名稱是遊戲化稱呼，不代表官方認定。金卡不看 OVR，只給黃金世代老將，一隊限 1 人。鑽卡是額外比賽冠軍或推薦滿人拿到的特殊卡，不能交易、不能刪除。同一人只能有一張（名單或保管箱）。任何管道取得已擁有的人都算重複卡，不進第二張，依卡色換成黃金：青 10、綠 15、藍 25、紅 40、紫 70、金 100、鑽石 120；跳出小視窗通知，原卡與訓練保留。沒有三張隨便合成養超模這條路。"
		"lineup":
